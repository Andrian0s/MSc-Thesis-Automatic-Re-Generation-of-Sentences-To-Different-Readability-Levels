...
file_names = [
    'base_separate_frozen_embed_readability_init.log',
    'base_separate_unfrozen_embed_readability_init.log',
    'small_separate_frozen_embed_readability_init.log',
    'small_separate_unfrozen_embed_readability_init.log',
]
