...
file_names = [
    'base_combined_unfrozen_embed_readability_init.log',
    'small_combined_unfrozen_embed_readability_init.log',
    'base_combined_frozen_embed_readability_init.log',
    'small_combined_frozen_embed_readability_init.log',
]
