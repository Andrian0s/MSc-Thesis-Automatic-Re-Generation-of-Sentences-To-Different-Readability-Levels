...
file_names = [
    'small_pairwise_adapters.log',
    'base_pairwise_adapters.log',
    'small_pairwise_full_model.log',
    'base_pairwise_full_model.log',
    'small_string_prefix.log',
    'base_string_prefix.log',
...
# dictionary to hold model name as key and top 10 SARI scores as values
top_SARI_scores = {}
top_SARI_steps = {}
...
for j, (log_content, model_name) in enumerate(zip(log_contents, model_names)):
    ...
    SARI_metric = [metric for sublist in metrics[model_name] for metric in sublist if "SARI" in metric][2]
    print(SARI_metric)
    ...
    for metric in metrics_of_interest:
        full_metric = [m for sublist in metrics[model_name] for m in sublist if metric in m][2]
        print(full_metric)
