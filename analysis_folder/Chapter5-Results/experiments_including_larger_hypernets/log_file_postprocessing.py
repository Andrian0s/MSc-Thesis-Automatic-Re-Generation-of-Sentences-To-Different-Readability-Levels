...
file_names = [
    ...
    'small_combined_readability_init_Lhypernet_test.log',
    'base_combined_readability_init_Lhypernet.log',
    'small_separate_readability_init_Lhypernet.log',
    'base_separate_readability_init_Lhypernet.log',
    'small_original_hyperformer++.log',
    'base_original_hyperformer++.log',
